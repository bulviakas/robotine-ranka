...
TO_FRIDGE_DURATION              = 3.8 * (1 + ROBOT_SPEED)
RECOVER_FROM_FRIDGE_DURATION    = 2.3 * (1 + ROBOT_SPEED)
TO_TEST_DURATION                = 4.8 * (1 + ROBOT_SPEED)
SHAKE_DURATION                  = 15.1 * (1 + ROBOT_SPEED)
RECOVER_FROM_TEST_DURATION      = 2.2 * (1 + ROBOT_SPEED)
TO_SCAN_DURATION                = 3.8 * (1 + ROBOT_SPEED)
RECOVER_FROM_SCAN_DURATION      = 2.3 * (1 + ROBOT_SPEED)